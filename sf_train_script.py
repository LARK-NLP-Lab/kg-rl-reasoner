...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, default='./models2/Qwen7B_SFT_d1', help='output directory')
    ...
    parser.add_argument('--eval_steps', type=int, default=6000, help='steps when to run evaluation')
